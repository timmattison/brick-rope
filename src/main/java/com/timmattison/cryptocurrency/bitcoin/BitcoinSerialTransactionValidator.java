...
public class BitcoinSerialTransactionValidator implements TransactionValidator {
    ...
    @Override
    public boolean isValid(Transaction transaction) throws SQLException, IOException, ClassNotFoundException {
        ...
        // If we got here this transaction looks good
        return true;
    }
}
