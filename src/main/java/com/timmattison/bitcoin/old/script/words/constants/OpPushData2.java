package com.timmattison.bitcoin.old.script.words.constants;

import com.timmattison.bitcoin.old.script.ByteConsumingWord;
...
public class OpPushData2 extends ByteConsumingWord {
    ...
    protected void doAdditionalProcessing(ByteArrayInputStream input) {
        ...
        int bytesToRead = ((int) (this.input[0] + (this.input[1] << 8))) & 0xFFFF;
